...
- [CNOTE Masternode Setup](#CNOTE-masternode-setup)  
  ...
  * [Guide for CNOTE v2.0.1 Masternode Update](#guide-for-cnote-v200-masternode-update)  
...
## Guide for CNOTE v2.0.1 Masternode Update

These instructions are for users who are **already running an older CNOTE masternode** and need to upgrade their VPS to **v2.0.1**.  
The update script stops the running daemon, installs the new v2.0.1 binaries, refreshes the sapling params and re-syncs from bootstrap. As long as you re-use your existing masternode private key, your node keeps the same identity and you do **not** need to reconfigure it from your QT wallet.
